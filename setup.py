...
setup(
    ...
    url="https://github.com/adafruit/Adafruit_CircuitPython_MagTag",
    # Author details
    ...
    keywords="adafruit blinka circuitpython micropython magtag eInk ePaper EPD Portal",
    # You can just specify the packages manually here if your project is
    # simple. Or you can use find_packages().
    packages=["adafruit_magtag"],
)
